    ...
    /* static void AABBtoAABBManifold(b2AABB A, b2AABB B, b2Manifold* m)
     {
         ...
         b2Vec3 eA = b2Abs(b2AABB_Extents(A)); // c2Absv(c2Mulvs(b2Sub(A.max, A.min), 0.5f));
         b2Vec3 eB = b2Abs(b2AABB_Extents(B)); // c2Absv(c2Mulvs(b2Sub(B.max, B.min), 0.5f));
         b2Vec3 d = b2Sub(mid_b, mid_a);

         // calc overlap on x, y, and z axes
    ...
    /* static void AABBtoAABBManifold(b2AABB A, b2AABB B, b2Manifold* m)
     {
         ...
         if (dx < dy && dx < dz)
         {
             ...
             {
                 n =  { 1.0f, 0.0f, 0.0f };
                 p =  { mid_a.x - eA.x, mid_a.y, mid_a.z };
             }
             else
             {
                 n =  { -1.0f, 0.0f, 0.0f };
         ...
         else if (dy < dz)
         {
             ...
             {
                 n =  { 0.0f, 1.0f, 0.0f };
                 p =  { mid_a.x, mid_a.y - eA.y, mid_a.z };
             }
             else
             {
                 n =  { 0.0f, -1.0f, 0.0f };
         ...
         else
         {
             ...
             {
                 n =  { 0.0f, 0.0f, 1.0f };
                 p =  { mid_a.x, mid_a.y, mid_a.z - eA.z };
             }
             else
             {
                 n =  { 0.0f, 0.0f, -1.0f };
